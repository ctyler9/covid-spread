...
def main():
    ...
    names = ['Dougherty', 'Lee', 'Randolph', 'Mitchell']
    fids = [13095.0, 13003.0, 13177.0, 13007.0]
    graph = avar.combine_connected_graphs('Georgia', fids)#[13095.0, 13003.0, 13177.0, 13007.0])
    print("ok")
    ...
    print("algo 1")
    avar.gillespie()
    print("algo 2, creating data now")
    output_lst = []
