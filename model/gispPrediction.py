...
class gispPrediction():
    ...
    def create_data(self, dataMatcher, iRate, rRate, state):
        #unpack
        ...
        self.df = df
        df.to_csv("../data/output_{0}_{1}_{2}.csv".format(state, iRate, rRate))
...
def main(a):
    ...
    avar.gillespie()
    avar.create_data(output_lst, infection_rate, recovery_rate, state)
    #avar.plot_graph()
